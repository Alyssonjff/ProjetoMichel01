...
class UsuariosTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('Profissao_usuario')
            ->maxLength('Profissao_usuario', 220)
            ->requirePresence('Profissao_usuario', 'create')
            ->notEmptyString('Profissao_usuario');
